...
This directory adds Kubernetes manifests for the Animal Clinic microservices stack without changing the existing Maven, Docker, or Docker Compose workflow.
